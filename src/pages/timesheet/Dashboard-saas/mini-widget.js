            ...
            <CardBody>
              <div className="d-flex align-items-center mb-3">
                <div className="avatar-xs me-3">
                  <span className={"avatar-title text-center rounded-circle bg-primary-subtle text-primary font-size-18"}>
                    <i className={report.icon} />
                  </span>
                </div>
                <h5 className="font-size-14 mb-0 text-primary">{report.title}</h5>
              </div>
