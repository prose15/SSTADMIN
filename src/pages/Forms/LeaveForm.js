...
import {
  collection, addDoc, Timestamp, getDoc, doc, updateDoc
  ...
  const { values, handleBlur, handleChange, handleSubmit, errors, touched } = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (checkBookedValues === 1) {
        setAlertMsg("You have already booked a leave between these days!")
              ...
              <Card className=' w-100  mx-auto'>
                <CardBody >
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    {
                      ( countDays(new Date(values.fromDate), new Date(values.toDate)) == 1) ? (
                        <>
                          <Label>Session</Label>
                          <select
                            className={errors.session ? "  border-danger form-control" : "form-select"}
                            name="session"
                            onChange={handleChange}
                            onBlur={handleBlur}
