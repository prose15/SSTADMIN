...
const leaveprojects = [
  {
    ...
    // commentsCount: 183,
    team: [
      { id: 1, img: "avatar3", fullname: "Yuvashini" },
      { id: 2, img: "avatar2", fullname: "Gobi Nagarajan" },
      { id: 3, img: "avatar7", fullname: "Krishna Kumar"}
      // { id: 1, img: "Null", name: "Y", color: "info", fullname: "Yuvashini" },
      // { id: 2, img: "Null", name: "G", color: "primary", fullname: "Gobi Nagarajan" },
      // { id: 3, img: "Null", name: "K", color: "warning", fullname: "Krishna Kumar" }
    ],
...
export { leaveprojects, options, series, projectListData, OverviewTeamMember };
